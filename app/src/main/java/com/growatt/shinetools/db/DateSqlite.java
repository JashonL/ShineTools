...
public class DateSqlite extends SQLiteOpenHelper{
	String createMaxTable = "CREATE TABLE IF NOT EXISTS max_tools_sqlite(jsonkey VARCHAR(100) PRIMARY KEY ,value VARCHAR ,time VARCHAR(100))";
	/**
	 */
//	private static  int version = 5; //���ݿ�汾
	...
	public DateSqlite(Context context) {
		super(context, GlobalConstant.getSqliteName(context), null, version);
	}
