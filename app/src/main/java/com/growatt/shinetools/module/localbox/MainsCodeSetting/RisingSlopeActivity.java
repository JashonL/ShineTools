...
public class RisingSlopeActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,
   ...
   private MaxConfigControl.MaxSettingEnum enum_item;
    ...
    ConnectHandler connectHandler = new ConnectHandler() {
        ...
        public void connectFail() {
            ...
            MyControl.showJumpWifiSet(RisingSlopeActivity.this);
        }

        @Override
        public void sendMsgFail() {
            manager.disConnectSocket();
            MyControl.showTcpDisConnect(RisingSlopeActivity.this, getString(R.string.disconnet_retry),
                    () -> {
                        connetSocket();
                    }
            );
