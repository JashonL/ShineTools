 ...
 * tlx  充放电管理界面
 */
public class TLXToolChargeManagerActivity extends DemoBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tlxtool_charge_manager);
    ...
    private void initListener() {
        mAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            switch (position){
                ...
                case 3:type = 0;pos = 21;break;
                case 4:type = 1;pos = 25;break;
                case 5:type = 1;pos = 26;break;
                case 6:type = 1;pos = 27;break;
                case 7:type = 1;pos = 28;break;
            }
            switch (type){
                case 0:
                ...
                case 1:
                    ...
                    break;
                case 10:
                    clazz = TLXHToolTimerActivity.class;
                    break;
            }
            if (clazz != null) {
