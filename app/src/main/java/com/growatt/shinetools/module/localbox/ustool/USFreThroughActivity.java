...
public class USFreThroughActivity extends DemoBase implements UsThroughAdapter.OnChildCheckLiseners, BaseQuickAdapter.OnItemClickListener{
...
//    private USVThroughAdatper mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usfre_through);
...
//        titles = new String[]{
//                "OF2 Frequency", "OF2 Time"
//                , "OF1 Frequency", "OF1 Time"
//                , "UF1 Frequency", "UF1 Time"
...
//        };
        ...
        regists = new int[]{
                54, 72, 58, 74, 55, 73, 59, 75
        };
        mulits = new float[]{
                0.01f, 0.02f, 0.01f, 0.02f, 0.01f, 0.02f, 0.01f, 0.02f
        };
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        switch (position){
            case 0://AC1频率限制 高
                tips=getString(R.string.android_key3048)+":"+"45Hz~50Hz/55Hz~60Hz(AC1>AC2)";
                break;
            case 1://AC1电压限制时间 高
                tips=getString(R.string.android_key3048)+":"+"0.10s~300s";
                break;
            ...
            case 4://AC1电压限制 低
                tips=getString(R.string.android_key3048)+":"+"50Hz~55Hz/60Hz~65Hz(AC1<AC2)";
                break;
            case 5://AC1电压限制时间 低
                tips=getString(R.string.android_key3048)+":"+"0.10s~300s";
                break;
