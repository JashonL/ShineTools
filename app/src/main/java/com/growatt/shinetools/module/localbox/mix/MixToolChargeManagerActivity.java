 ...
 * tlx  充放电管理界面
 */
public class MixToolChargeManagerActivity extends DemoBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mix_tool_charge_manager);
    ...
    private void initListener() {
        mAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            switch (position){
                ...
                case 1:type = 1;pos = 34;break;
                case 2:type = 1;pos = 35;break;
                case 3:type = 0;pos = 35;break;
                case 4:type = 1;pos = 36;break;
                case 5:type = 1;pos = 37;break;
                case 6:type = 1;pos = 38;break;
                case 7:type = 1;pos = 39;break;
            }
            switch (type){
                case 0:
                ...
                case 1:
                    ...
                    break;
                case 10:
                    clazz = MixToolTimerActivity.class;
                    break;
            }
            if (clazz != null) {
