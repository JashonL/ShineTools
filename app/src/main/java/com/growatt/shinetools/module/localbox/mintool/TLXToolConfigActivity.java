    ...
    private void initString() {
        if (user_type == END_USER) {
            ...
            titles = new String[]{
                    ...
                    getString(R.string.m419Qv切入切出高压),
                    getString(R.string.m420Qv切入切出低压),
                    getString(R.string.m421Qv切入切出功率),
                    getString(R.string.m422无功曲线切入切出电压),
                    getString(R.string.m390PF调整值),
                    getString(R.string.m391PF限制负载百分比点) + "1~4",
                    getString(R.string.m392PF限制功率因数) + "1~4",
                    getString(R.string.m防逆流设置),
                    getString(R.string.m防逆流功率百分比),
                    getString(R.string.m防逆流失效后默认功率百分比)
                    , getString(R.string.AFCI阈值) + "1",
                    getString(R.string.AFCI阈值) + "2",
                    getString(R.string.AFCI阈值) + "3",
                    getString(R.string.FFT最大累计次数)
                    , getString(R.string.m干接点状态),
                    getString(R.string.m干接点开通的功率百分比),
                    getString(R.string.m干接点关闭功率百分比)
//
        ...
        if (user_type == END_USER) {
            mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    ...
                    int pos = position;
                    switch (position) {
                        case 0: case 7: case 8: case 14: case 23:
                            if (position == 7) {
                                pos = 26;
                            }
                            if (position == 8) {
