 ...
 * Max 本地调试国家以及安规
 */
public class TLXParamCountryActivity extends DemoBase implements BaseQuickAdapter.OnItemClickListener {
    String readStr;
...
//        }
                ...
                //GeneralModel
                    {
                        {"S01", "VDE0126"}, {"S34", "TUNISIA"},
                        {"S11", "Ukraine Or Others"}, {"S07", "VDE-AR-N4105"},
...
//                break;
            case R.id.btnSetting:
                ...
                if (mItem != null && mItem.isSave()){
                    SharedPreferencesUnit.getInstance(TLXParamCountryActivity.this).put(GlobalConstant.TOOL_TLX_MODEL_COUNTRY,mItem.getModelTitle() + ":" + mItem.getIndex());
                }
                break;
        }
    }
