...
public class USVWattActivity extends DemoBase implements UsThroughAdapter.OnChildCheckLiseners, BaseQuickAdapter.OnItemClickListener{
...
//    private USVThroughAdatper mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usvthrough);
...
//        };
        titles = new String[]{
                getString(R.string.电压有功高压高点)
                ,getString(R.string.电压有功高压低点)
                ,getString(R.string.电压有功低压高点)
                ,getString(R.string.电压有功低压低点)
                ,getString(R.string.电压有功响应时间)
        };
        units = new String[]{
                "V", "V", "V", "V", "s"
        };
...
//                            }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        switch (position){
            ...
            case 2://AC2电压限制 高
                tips=getString(R.string.android_key3048)+":"+"208/240";
                break;
            ...
            case 4://AC1电压限制 低
                tips=getString(R.string.android_key3048)+":"+"0~20";
                break;
