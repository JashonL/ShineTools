...
public class TLXHToolConfigActivity extends DemoBase {
    ...
    private void initString() {
        ...
        if (user_type == END_USER) {
            //11,18,19,23,27,28,29,30,38,39,42,43
            titles = new String[]{
                    ...
                    , getString(R.string.m400容性载率), getString(R.string.m401容性PF), getString(R.string.m默认PF曲线), getString(R.string.m422无功曲线切入切出电压), getString(R.string.m391PF限制负载百分比点)+"1~4"
                    , getString(R.string.m392PF限制功率因数)+"1~4", getString(R.string.m425启动时间), getString(R.string.m426故障恢复后重启延迟时间), getString(R.string.m418电源启动重启斜率)
                    , getString(R.string.m防逆流设置), getString(R.string.m防逆流功率百分比), getString(R.string.m防逆流失效后默认功率百分比)
                    , getString(R.string.m干接点开通的功率百分比), getString(R.string.m干接点关闭功率百分比), getString(R.string.m414N至GND监测功能使能), getString(R.string.m406过频降额起点)
                    , getString(R.string.m407频率负载限制率), getString(R.string.m409过频降额延时)
                    , getString(R.string.m408Qv无功延时), getString(R.string.m410Qv曲线Q最大值), getString(R.string.m419Qv切入切出高压), getString(R.string.m420Qv切入切出低压)
                    , getString(R.string.m421Qv切入切出功率), getString(R.string.m手动离网使能), getString(R.string.m离网使能)
