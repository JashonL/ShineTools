...
//                "可远程扫描每路I-V曲线或P-V曲线", "可远程、快速、精确地进行故障定位", "可实时观察逆变器电压电流质量等", "一键检测电站环境信息，包括I-V曲线扫描，电网侧电压波形，THDV以及线路阻抗"
    ...
    private void initIntent() {
        ...
        if (mIntent != null) {
            ...
            deviceType=mIntent.getIntExtra(DeviceConstant.KEY_DEVICE_TYPE,2);
        }
    }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, final int position) {
        if (adapter == mAdapter) {
            if (END_USER==user_type){
                switch (position) {
                    case 0:
                        jumpMaxSet(MaxCheckIV1500VActivity.class, titles[position]);
                        break;
                    case 1:
                        MultiSelectPopWindow pop = new MultiSelectPopWindow.Builder(MaxCheck1500VActivity.this)
                                    ...
                                    public void onClick(ArrayList<Integer> indexList, ArrayList<String> selectedList) {
                                        ...
                                        if (indexList != null && indexList.size() > 0) {
                                            ...
                                            new CircleDialog.Builder()
                                                    ...
                                                    .setText(noteStr + new DecimalFormat("0.#").format(totalTime / 60.0f) + "min")
                                                    .setPositive(getString(R.string.all_ok), new View.OnClickListener() {
                                                        @Override
                                                        public void onClick(View v) {
                                                            Intent mIntent = new Intent(MaxCheck1500VActivity.this, MaxCheckOneKey1500Activity.class);
                ...
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        jumpMaxSet(MaxCheckError1500VActivity.class, titles[position]);
                        break;
                    case 2:
