...
public class OldInvConfigType1AndPFActivity extends DemoBase {
    String readStr ;
            ...
            switch (what) {
                ...
                case SocketClientUtil.SOCKET_SEND:
                    ...
                    if (nowSet != null) {
                        if (nowPos >= nowSet.length-1) {
                            ...
                            nowPos = nowPos + 1;
                            sendBytes = SocketClientUtil.sendMsgToServerOldInv(mClientUtilWriter, nowSet[nowPos]);
                ...
                case SocketClientUtil.SOCKET_RECEIVE_BYTES:
                    ...
                    try {
                        ...
                        if (isCheck) {
                            if (TextUtils.isEmpty(titles[mType][nowPos])){
