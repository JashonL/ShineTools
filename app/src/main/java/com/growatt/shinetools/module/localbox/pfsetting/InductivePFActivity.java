...
public class InductivePFActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,
    ...
    ConnectHandler connectHandler = new ConnectHandler() {
        ...
        public void connectFail() {
            ...
            MyControl.showJumpWifiSet(InductivePFActivity.this);
        }

        @Override
        public void sendMsgFail() {
            manager.disConnectSocket();
            MyControl.showTcpDisConnect(InductivePFActivity.this, getString(R.string.disconnet_retry),
                    () -> {
                        connetSocket();
                    }
            );
