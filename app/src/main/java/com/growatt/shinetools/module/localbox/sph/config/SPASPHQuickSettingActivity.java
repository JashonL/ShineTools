...
public class SPASPHQuickSettingActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,
    ...
    protected void initData() {
        ...
        List<ALLSettingBean> settingList
                = SPHSPAConfigControl.getSettingList(SPHSPAConfigControl.SphSpaSettingEnum.SPH_SPA_QUICK_SETTING, this);
    ...
    ConnectHandler connectHandler = new ConnectHandler() {
        ...
        public void connectFail() {
            ...
            MyControl.showJumpWifiSet(SPASPHQuickSettingActivity.this);
        }

        @Override
        public void sendMsgFail() {
            manager.disConnectSocket();
            MyControl.showTcpDisConnect(SPASPHQuickSettingActivity.this, getString(R.string.disconnet_retry),
                    () -> {
                        connetSocket();
                    }
            );
