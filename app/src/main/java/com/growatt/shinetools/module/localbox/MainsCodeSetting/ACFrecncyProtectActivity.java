...
public class ACFrecncyProtectActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,
   ...
   private MaxConfigControl.MaxSettingEnum enum_item;
    ...
    ConnectHandler connectHandler = new ConnectHandler() {
        ...
        public void connectFail() {
            ...
            MyControl.showJumpWifiSet(ACFrecncyProtectActivity.this);
        }

        @Override
        public void sendMsgFail() {
            manager.disConnectSocket();
            MyControl.showTcpDisConnect(ACFrecncyProtectActivity.this, getString(R.string.disconnet_retry),
                    () -> {
                        connetSocket();
                    }
            );
