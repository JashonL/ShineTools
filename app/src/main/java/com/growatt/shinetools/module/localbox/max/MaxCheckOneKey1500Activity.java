 ...
 * Max 一键诊断
 */
public class MaxCheckOneKey1500Activity extends DemoBase implements
...
//                            refreshUI();
    ...
    private void initRecyclerViewIV() {
        ...
        mAdapterIV = new MaxCheckIV1500Adapter(R.layout.item_max_check_iv_act, mListIV);
    ...
    private void initLineChartIV() {
        ...
        initDataIV();
        initLastDataIV();
        MaxUtil.setLineChartDataSpeColor(mContext, mLineChartIV, dataList, colors, colors, dataList.size(), R.color.highLightColor,false);
        hideIVLast();
    }
...
//                        if (EasyPermissions.hasPermissions(MaxCheckOneKey1500Activity.this, PermissionCodeUtil.PERMISSION_EXTERNAL_STORAGE)) {
//                            share();
//                        } else {
//                            EasyPermissions.requestPermissions(MaxCheckOneKey1500Activity.this, String.format(getString(R.string.m权限获取某权限说明), getString(R.string.m存储)), PermissionCodeUtil.PERMISSION_EXTERNAL_STORAGE_CODE, PermissionCodeUtil.PERMISSION_EXTERNAL_STORAGE);
//                        }
//                    } else {
//                        share();
//                    }
...
//        new CircleDialog.Builder(MaxCheckOneKey1500Activity.this)
//                .setTitle(getResources().getString(R.string.温馨提示))
//                .setText("截图保存到相册")
//                .setNegative(getResources().getString(R.string.all_no), new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        ShareUtil.shareLongPicture(MaxCheckOneKey1500Activity.this, picName, titleStr, mScrollView, shareListener, false);
//                    }
//                })
//                .setPositive(getResources().getString(R.string.all_ok), new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        ShareUtil.shareLongPicture(MaxCheckOneKey1500Activity.this, picName, titleStr, mScrollView, shareListener, true);
//                    }
//                }).show();
//    }
    ...
    public void setIPVData(int type) {
        switch (type) {
            ...
            case 1://P-V
                ...
                MaxUtil.setLineChartDataSpeColor(mContext, mLineChartIV, newLists, colors, colors, newLists.size(), R.color.highLightColor,false);
                break;
        }
    }
