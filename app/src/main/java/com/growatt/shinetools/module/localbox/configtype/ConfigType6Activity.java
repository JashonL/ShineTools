 ...
 * 6个寄存器分别设置
 */
public class ConfigType6Activity extends BaseActivity implements Toolbar.OnMenuItemClickListener{
    ...
    protected int getContentView() {
        mContext=this;
        return R.layout.activity_config_type6;
    }
...
//                {"PF调整值(101)", "PF调整值(102)", "PF调整值(103)", "PF调整值(104)", "PF调整值(105)", "PF调整值(106)"}
        ...
        tvTitle5.setText(titles[mType][4]);
        tvTitle6.setText(titles[mType][5]);
        //需要设置的内容
        nowSet = new int[][]{
                {6, funSet[mType][0], -1}
                , {6, funSet[mType][1], -1}
...
//                            } else if (nowPos == 4) {
//                                tvContent5.setText(content);
//                            } else if (nowPos == 5) {
//                                tvContent6.setText(content);
//                            }
                ...
                case SocketClientUtil.SOCKET_RECEIVE_BYTES:
                    ...
                    try {
                        ...
                        if (isCheck) {
                            ...
                            tvContent5.setText(readStr + ":" + value5);
                            tvContent6.setText(readStr + ":" + value6);
    ...
    public void onViewClicked() {
        ...
        String content5 = etContent5.getText().toString();
        String content6 = etContent6.getText().toString();
