...
public class MaxCheckError1500VActivity extends DemoBase implements BaseQuickAdapter.OnItemChildClickListener, View.OnClickListener {
...
//    }
    ...
    private void initView() {
        ...
        int num=deviceType==DeviceConstant.MAX_MAX_X_INDEX?200:300;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case SOCKET_SERVER_SET://跳转到wifi列表
                    try {
                        CommenUtils.showJumpWifiSet(MaxCheckError1500VActivity.this);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    reStartBtn();
