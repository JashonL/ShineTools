...
public class USGridActivity extends DemoBase implements UsThroughAdapter.OnChildCheckLiseners, BaseQuickAdapter.OnItemClickListener{
...
//    private USVThroughAdatper mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usgrid);
...
//        titles = new String[]{
//                "OV2 Voltage", "OV2 Time"
//                , "OV1 Voltage", "OV1 Time"
//                , "UV1 Voltage", "UV1 Time"
//                , "UV2 Voltage", "UV2 Time"
//                , "UV3 Voltage", "UV3 Time"
//        };
        titles = new String[]{
                getString(R.string.并网电压高值)
                ,getString(R.string.并网电压低值)
                ,getString(R.string.并网频率高值)
                ,getString(R.string.并网频率低值)
                ,getString(R.string.开机连接时间)
                ,getString(R.string.并网重连时间)
        };
        units = new String[]{
                "V", "V", "Hz", "Hz", "s", "s"
        };
...
//        mAdapter = new USVThroughAdatper(R.layout.item_us_vthrough, mList);
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        switch (position){
            ...
            case 3://并网频率低值
                tips=getString(R.string.android_key3048)+":"+"49~49.9Hz";
                break;

            case 4://开机连接时间
                tips=getString(R.string.android_key3048)+":"+"0~600s";
                break;
