...
public class MaxGridCodeSecondActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,
   ...
   private MaxConfigControl.MaxSettingEnum enum_item;
    ...
    protected void initData() {
        ...
        enum_item = MaxConfigControl.MaxSettingEnum.MAX_GRID_CODE_PARAMETERS_SETTING;
        switch (curpos){
            case 0://PF设置
                enum_item=MaxConfigControl.MaxSettingEnum.MAX_GRID_SECOND_PF_SETTING;
                break;
            case 1://频率有功
            ...
            case 2://电压无功
                ...
                break;
            case 3://电源启动重启斜率
                enum_item=MaxConfigControl.MaxSettingEnum.MAX_GRID_SECOND_POWERE_START_SETTING;
                break;
            case 4://AC电压保护
                enum_item=MaxConfigControl.MaxSettingEnum.MAX_GRID_SECOND_AC_VOLTAGE_PROTECT;
                break;
            case 5://AC频率保护
                enum_item=MaxConfigControl.MaxSettingEnum.MAX_GRID_SECOND_AC_FRENCY_PROTECT;
                break;
            case 6://并网范围
                enum_item=MaxConfigControl.MaxSettingEnum.MAX_GRID_SECOND_SYNCHORNIZATION_RANGE;
                break;
        }
        //系统设置项
    ...
    ConnectHandler connectHandler = new ConnectHandler() {
        ...
        public void connectFail() {
            ...
            MyControl.showJumpWifiSet(MaxGridCodeSecondActivity.this);
        }

        @Override
        public void sendMsgFail() {
            manager.disConnectSocket();
            MyControl.showTcpDisConnect(MaxGridCodeSecondActivity.this, getString(R.string.disconnet_retry),
                    () -> {
                        connetSocket();
                    }
            );
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        switch (enum_item){
            case MAX_GRID_SECOND_PF_SETTING://PF设置
                pfSetting(position);
                break;
            case MAX_GRID_SECOND_FRENCY_WATT_SETTING://频率有功
                setFrencyWatt(position);
                break;
            case MAX_GRID_SECOND_VOLTAGE_SETTING://电压无功
                setVoltage(position);
                break;
            case MAX_GRID_SECOND_POWERE_START_SETTING:
