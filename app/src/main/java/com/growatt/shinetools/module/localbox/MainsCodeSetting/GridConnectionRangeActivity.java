...
public class GridConnectionRangeActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,
   ...
   private MaxConfigControl.MaxSettingEnum enum_item;
    ...
    ConnectHandler connectHandler = new ConnectHandler() {
        ...
        public void connectFail() {
            ...
            MyControl.showJumpWifiSet(GridConnectionRangeActivity.this);
        }

        @Override
        public void sendMsgFail() {
            manager.disConnectSocket();
            MyControl.showTcpDisConnect(GridConnectionRangeActivity.this, getString(R.string.disconnet_retry),
                    () -> {
                        connetSocket();
                    }
            );
