...
public class OldInvAdvanceSetActivity extends DemoBase {
    ...
    private void initIntent() {
        ...
        if (mIntent != null){
            ...
            if (isShow && getLanguage() == 0){
                tvRight.setText(R.string.保护参数);
                tvRight.setOnClickListener(view -> jumpTo(ProtectParamActivity.class,false));
            }
        }
    }
    ...
    private void initRecyclerView() {
        mRvSend.setLayoutManager(new LinearLayoutManager(this));
        ...
        mRvReceiver.setAdapter(mReceiverAdapter);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case SocketClientUtil.SOCKET_SEND:
                    ...
                    sendBytes = SocketClientUtil.sendMsgToServerOldInv(mClientUtilWriter, funWrite);
                    //移除外部协议
...
//                        boolean isCheck = Arrays.equals(sendBytes, bytes);
                    ...
                    break;
                default:
                    BtnDelayUtil.dealMaxBtnWrite(this,what,mContext,mBtnStart);
                    break;
            }
        }
    };
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case SocketClientUtil.SOCKET_SEND:
                    ...
                    byte[] sendBytesR = SocketClientUtil.sendMsgToServerOldInv(mClientUtilRead, funRead);
                ...
                case SocketClientUtil.SOCKET_RECEIVE_BYTES:
                    ...
                    break;
                default:
                    BtnDelayUtil.dealMaxBtn(this,what,mContext,mBtnStart);
                    break;
            }
        }
    };
...
//                connectSendMsg();
                ...
                mReceiverAdapter.setNewData(new ArrayList<String>());
                //判空
                if (isEmpty(mEtCommand,mEtLengthData,mEtRegisterAddress)) return;
                try {
                    //解析数据
                    String commType = mEtCommand.getText().toString();
                    String startRegister = mEtRegisterAddress.getText().toString();
                    String lenOrData = mEtLengthData.getText().toString();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case SocketClientUtil.SOCKET_RECEIVE_BYTES:
                    ...
                    break;
                default:
                    BtnDelayUtil.dealTLXBtn(this, what, mContext);
                    break;
            }
        }
    };
