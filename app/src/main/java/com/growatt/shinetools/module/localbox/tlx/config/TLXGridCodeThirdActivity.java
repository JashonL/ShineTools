...
public class TLXGridCodeThirdActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,
    ...
    protected void initData() {
        ...
        enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_INDUCTIVE_REACTIVE_POWER;
        switch (curpos) {
            case 1://感性载率
                enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_INDUCTIVE_REACTIVE_POWER;
                break;
            case 2://容性载率
                enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_CAPACITIVE_REACTIVE_POWER;
                break;
            case 3://容性PF
                enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_CAPACITIVE_PF;
                break;
            case 4://感性PF
                enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_INDUCTIVE_PF;
                break;
            case 5://无功曲线切入/切出电压
                enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_PF_CURVE_INOUT_VAC;
                break;
            case 6://PF校准系数
                enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_PF_CALIBRATION_FACTOR;
                break;
            case 7://PF限制负载百分比点
                enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_PF_LIMIT_POINT_OF_PF_LOAD;
                break;
            case 8://PF限值
                enum_item = TLXConfigControl.TlxSettingEnum.TLX_GRID_THIRE_LIMIT_POINT_OF_PF;
                break;
        }
        //系统设置项
    ...
    ConnectHandler connectHandler = new ConnectHandler() {
        ...
        public void connectFail() {
            ...
            MyControl.showJumpWifiSet(TLXGridCodeThirdActivity.this);
        }

        @Override
        public void sendMsgFail() {
            manager.disConnectSocket();
            MyControl.showTcpDisConnect(TLXGridCodeThirdActivity.this, getString(R.string.disconnet_retry),
                    () -> {
                        connetSocket();
                    }
            );
        ...
        public void receveByteMessage(byte[] bytes) {
            if (type == 0) {
                ...
                switch (enum_item) {
                    case TLX_GRID_THIRE_INDUCTIVE_REACTIVE_POWER://感性载率设置
                    case TLX_GRID_THIRE_CAPACITIVE_REACTIVE_POWER://容性载率设置
                        getInductive();
                        break;
    ...
    private void parseMax(byte[] bytes) {
        ...
        //解析int值
        switch (enum_item) {
            case TLX_GRID_THIRE_INDUCTIVE_REACTIVE_POWER://感性载率解析
            ...
            case TLX_GRID_THIRE_INDUCTIVE_PF:
                parserPF(bs);
                break;
            case TLX_GRID_THIRE_PF_CURVE_INOUT_VAC://无功曲线切入电压
                parserCuveInouTvac(bs);
                break;
            case TLX_GRID_THIRE_PF_CALIBRATION_FACTOR://校准系数
                parserCaliBarLation(bs);
                break;
            case TLX_GRID_THIRE_PF_LIMIT_POINT_OF_PF_LOAD://PF限制负载百分比点
