...
public class MixBdcActivity extends DemoBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mix_bdc);
    ...
    private void refreshUI() {
        ...
        contents.add(String.valueOf(storageBeen.getBdcBatV()));
        contents.add(storageBeen.getBdcSoc());
        contents.add(String.valueOf(storageBeen.getBdcPCharge()));
        contents.add(String.valueOf(storageBeen.getBdcPDisCharge()));
        contents.add(String.valueOf(storageBeen.getBdcVbatDsp()));
        initData(contents);
    }
    private void initRecyclerView() {
        titles = new String[]{
                getString(R.string.m196电池电压),"SOC",
