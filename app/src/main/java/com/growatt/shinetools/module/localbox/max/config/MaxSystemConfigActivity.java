    ...
    private void parseMax(byte[] bytes) {
        ...
        switch (currentPos) {
            ...
            case 7://宽电网电压范围使能
                ...
                MaxSettingBean bean7 = usParamsetAdapter.getData().get(7);
            ...
            case 9://pv设置模式
                ...
                MaxSettingBean bean9 = usParamsetAdapter.getData().get(9);
            ...
            case 12://夜间SVG功能使能
                ...
                MaxSettingBean bean12 = usParamsetAdapter.getData().get(12);
            ...
            case 13://PID工作模式
                ...
                MaxSettingBean bean13 = usParamsetAdapter.getData().get(13);
