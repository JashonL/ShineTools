...
import com.growatt.shinetools.module.localbox.max.MaxErrorHistoryActivity;
...
public class TLXWarningActivity extends DemoBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tlxwarning);
                ...
                case SocketClientUtil.SOCKET_SEND:
                    BtnDelayUtil.sendMessage(this);
                        if (nowCount < funs.length) {
                            byte[] sendBytesR = SocketClientUtil.sendMsgToServer(mClientUtilRead, funs[nowCount]);
