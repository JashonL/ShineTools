...
public class OldInvModeSetActivity extends DemoBase {
    String readStr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_inv_mode_set);
                ...
                case SocketClientUtil.SOCKET_RECEIVE_BYTES:
                    ...
                    try {
                        ...
                        if (isCheck) {
                            ...
                            byte[] bs = MaxWifiParseUtil.subBytesFull(bsTotal,28,0,2);
