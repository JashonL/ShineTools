...
public class USVThroughActivity extends DemoBase implements UsThroughAdapter.OnChildCheckLiseners, BaseQuickAdapter.OnItemClickListener {
...
//        };
        ...
        mulits = new float[]{
                0.1f, 0.02f, 0.1f, 0.02f, 0.1f, 0.02f, 0.1f, 0.02f, 0.1f, 0.02f
        };
