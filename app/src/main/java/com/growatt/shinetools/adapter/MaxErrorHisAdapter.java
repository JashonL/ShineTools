...
public class MaxErrorHisAdapter extends BaseQuickAdapter<MaxErrorBean,BaseViewHolder>{
    public MaxErrorHisAdapter(@LayoutRes int layoutResId, @Nullable List<MaxErrorBean> data) {
        super(layoutResId, data);
    }

    public MaxErrorHisAdapter(@Nullable List<MaxErrorBean> data) {
        super(data);
    }
    ...
    protected void convert(BaseViewHolder helper, MaxErrorBean item) {
        ...
        helper.setText(R.id.tvErrContent,errStr);
